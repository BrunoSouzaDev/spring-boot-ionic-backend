...
CREATE TABLE `item_pedido` (
  ...
  `peidido_id` int(11) NOT NULL,
  `produto_id` int(11) NOT NULL,
  PRIMARY KEY (`peidido_id`,`produto_id`),
  KEY `FKtk55mn6d6bvl5h0no5uagi3sf` (`produto_id`),
  CONSTRAINT `FKdaaicfwolpu3ey49ux409ur10` FOREIGN KEY (`peidido_id`) REFERENCES `pedido` (`id`),
...
-- Dump completed on 2021-04-29 15:01:13
